...
## 文档与代码同步建议
当你修改以下模块时，请同步更新对应文档：
- 求解器变化 → [10_pbd.md](10_pbd.md), [11_xpbd.md](11_xpbd.md), [12_vbd.md](12_vbd.md)
- 运行方式变化 → [01_run_in_ui.md](01_run_in_ui.md), [02_run_in_cli.md](02_run_in_cli.md)
- 实验与参数变化 → [20_experiments.md](20_experiments.md), [README.md](../README.md)
- 常见错误与排查 → [90_faq.md](90_faq.md)
